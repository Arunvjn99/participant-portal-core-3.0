...
import { ArrowLeft, ArrowRight, TrendingUp, DollarSign, Calendar, Shield, Sparkles, Users } from "lucide-react";
...
import { RetirementReadinessStep } from "./components/RetirementReadinessStep";
            ...
            <div className="space-y-8">
              ...
              >
                ...
                <div className="relative">
                  ...
                  >
                    Select the plan that best fits your financial goals and tax strategy.
                  </motion.p>
                </div>
              </motion.div>
                ...
                <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      <h3 className="text-2xl font-bold text-gray-900">Need help deciding?</h3>
                    </div>
                    <p className="text-gray-600 text-base">
                      Not sure which plan is right for you? Our AI-powered comparison tool can help you understand the differences and make an informed decision.
                    </p>
                  </div>
                  <motion.div
        ...
        >
          ...
          >
            <Button
              ...
              size="lg"
            >
              Continue to {steps[currentStep + 1]?.label || "Next"}
