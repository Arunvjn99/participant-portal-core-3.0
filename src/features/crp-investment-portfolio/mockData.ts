...
export const mockAllocations: AllocationItem[] = [
  { name: "US Large Cap", currentPercent: 45, targetPercent: 40, color: "#6366f1", drift: 5 },
  { name: "International", currentPercent: 18, targetPercent: 20, color: "#8b5cf6", drift: -2 },
  { name: "Bonds", currentPercent: 22, targetPercent: 25, color: "#06b6d4", drift: -3 },
  { name: "Small Cap", currentPercent: 15, targetPercent: 15, color: "#f59e0b", drift: 0 },
];

export const ACCOUNT_OVERVIEW = {
  totalBalance: 142_894.52,
  ytdPercent: 8.4,
  vestedBalance: 138_400,
  outstandingLoan: 4_494.52,
  ytdContribution: 12_500,
  rateOfReturnPercent: 12.3,
  onTrack: {
    title: "On Track",
    message: "Your contributions are 2% higher than last year. Keep it up!",
  },
} as const;
