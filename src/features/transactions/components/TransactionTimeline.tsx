...
export const TransactionTimeline = memo(function TransactionTimeline() {
  ...
  return (
    <motion.section
      ...
      className="space-y-4"
    >
      <SectionHeader title="Activity intelligence timeline" subtitle="This week, this month, earlier" />
                ...
                {items.map((t) => (
                  <li key={t.id}>
                    <TransactionCard
                      ...
                      settlementDate={(t as ActivityItem).settlementDate}
                      estimatedRetirementImpact={(t as ActivityItem).estimatedRetirementImpact}
                    />
                  </li>
                ))}
              </ul>
