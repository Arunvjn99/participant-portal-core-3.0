...
/**
 * Enrollment “investments” step — fund selection / allocation UI (not the standalone portfolio dashboard).
 * Rendered inside `InvestmentsLayout` on `/enrollment/investments`.
 */
export function EnrollmentInvestmentsStepPage() {
  const { user } = useAuth();
...
export default EnrollmentInvestmentsStepPage;
