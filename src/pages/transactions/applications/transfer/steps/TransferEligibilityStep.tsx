...
export const TransferEligibilityStep = () => {
  ...
  return (
    <TransactionStepCard title={t("transactions.transfer.eligibility")}>
      <div className="space-y-6">
        ...
        >
          ...
          <div>
            <p className="font-semibold" style={{ color: "var(--enroll-text-primary)" }}>{t("transactions.transfer.canReallocate")}</p>
            <p className="mt-1 text-sm" style={{ color: "var(--enroll-text-secondary)" }}>
              {t("transactions.transfer.rebalanceDesc")}
            </p>
          </div>
        </div>
        <div className="p-3 rounded-[var(--radius-md)]" style={{ background: "var(--enroll-soft-bg)" }}>
          <p className="text-sm" style={{ color: "var(--enroll-text-secondary)" }}>
            {t("transactions.transfer.currentBalance")} <span className="font-semibold" style={{ color: "var(--enroll-text-primary)" }}>{formatCurrency(ACCOUNT_OVERVIEW.totalBalance)}</span>
          </p>
        </div>
      </div>
    </TransactionStepCard>
