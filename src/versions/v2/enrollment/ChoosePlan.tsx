                ...
                <button
                  ...
                  onClick={(e) => {
                    ...
                    useAIAssistantStore.getState().openAIModal({
                      prompt: PLAN_ASK_AI_PROMPT(plan.name),
                      autoSend: true,
                    });
                  }}
                  className={
                    isSelected
                      ? "order-2 sm:order-1 inline-flex min-h-[44px] w-full items-center justify-center gap-2 rounded-full border border-white/25 bg-white/10 px-3 py-2 text-sm font-semibold text-white/95 transition-transform hover:scale-[1.02] active:scale-[0.98] sm:min-h-0 sm:w-auto"
                      : "ai-assistant order-2 sm:order-1 inline-flex min-h-[44px] w-full items-center justify-center gap-2 rounded-full px-3 py-2 text-sm font-semibold text-white shadow-md transition-transform hover:scale-[1.02] active:scale-[0.98] sm:min-h-0 sm:w-auto"
                  }
